  ...
  return (
    <div className="flex shrink-0 items-center gap-1.5 sm:gap-2">
      {isAdmin ? (
        ...
        >
          <svg className="h-4 w-4 text-white/70 group-hover:text-white group-hover:rotate-90 transition-transform duration-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
